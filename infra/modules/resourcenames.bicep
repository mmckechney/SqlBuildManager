...
var postProvisionIdentityNameVar = '${prefixes.managedIdentity}${resourceEnvName}-postprovision'
var relayProxyIdentityNameVar = '${prefixes.managedIdentity}${resourceEnvName}-relayproxy'
var relayNamespaceNameVar = 'relay-${resourceEnvName}'
var relayPrivateEndpointNameVar = '${prefixes.privateEndpoint}${resourceEnvName}-relay'
var relayPrivateLinkNameVar = '${prefixes.privateLink}${resourceEnvName}-relay'
...
output postProvisionIdentityName string = postProvisionIdentityNameVar
output relayProxyIdentityName string = relayProxyIdentityNameVar
output relayNamespaceName string = relayNamespaceNameVar
output relayPrivateEndpointName string = relayPrivateEndpointNameVar
output relayPrivateLinkName string = relayPrivateLinkNameVar
