...
var identityNameVar = '${prefixes.managedIdentity}${resourceEnvName}-worker'
...
output orchestratorIdentityName string = '${prefixes.managedIdentity}${resourceEnvName}-orchestrator'
output mysqlDirectoryIdentityName string = '${prefixes.managedIdentity}${resourceEnvName}-mysql-directory'
output aksControlPlaneIdentityName string = '${prefixes.managedIdentity}${resourceEnvName}-aks-control'
output aksKubeletIdentityName string = '${prefixes.managedIdentity}${resourceEnvName}-aks-kubelet'
output batchStorageIdentityName string = '${prefixes.managedIdentity}${resourceEnvName}-batch-storage'
