...
$expectedNames = @{
    ...
    identityName            = "id-dev-01-worker"
    userAssignedIdentity   = "id-dev-01-worker"
    userAssignedIdentityName = "id-dev-01-worker"
    orchestratorIdentityName = "id-dev-01-orchestrator"
    mysqlDirectoryIdentityName = "id-dev-01-mysql-directory"
    aksControlPlaneIdentityName = "id-dev-01-aks-control"
    aksKubeletIdentityName   = "id-dev-01-aks-kubelet"
    batchStorageIdentityName = "id-dev-01-batch-storage"
    postProvisionIdentityName = "id-dev-01-postprovision"
    postProvisionContainerName = "ci-dev-01-postprovision"
    relayProxyIdentityName  = "id-dev-01-relayproxy"
    relayProxyContainerName = "ci-dev-01-relayproxy"
...
$expectedPrefixes = @{
    ...
    orchestratorIdentityName = $resourceTypePrefixes.managedIdentity
    mysqlDirectoryIdentityName = $resourceTypePrefixes.managedIdentity
