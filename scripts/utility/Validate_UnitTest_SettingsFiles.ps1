...
.PARAMETER testPath
    Path to the ExternalTest project directory. Default: ../../src/SqlBuildManager.Console.SqlServer.ExternalTest.
#>
param
(
    [string] $path = "..\..\src\TestConfig",
    [string] $testPath = "..\..\src\SqlBuildManager.Console.SqlServer.ExternalTest\"
)
