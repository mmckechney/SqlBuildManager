...
wt.exe -w new ^
  new-tab --title "SqlServer_External" -d "%WD%" -- "%PWSH%" -NoExit -File "%TAB_INIT%" -CommandText ".\run_all_sqlserver_external_tests_in_aci.ps1 -envName " ^
  ; new-tab --title "Postgres_External" -d "%WD%" -- "%PWSH%" -NoExit -File "%TAB_INIT%" -CommandText ".\run_all_postgres_external_tests_in_aci.ps1 -envName " ^
