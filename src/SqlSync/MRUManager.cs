...
namespace SqlSync.MRU
{
	...
	public class MRUManager
	{
        ...
        private ToolStripMenuItem mruParent;        // Recent Files menu item parent
        ...
        public void Initialize(Form owner, ToolStripMenuItem parentMenu, ToolStripMenuItem recentItemsMnu, string regPath)
        {
            ...
            menuItemMRU = recentItemsMnu;

            ////keep reference to MRU menu item parent
            //try
            //{
            //    this.mruParent = (MenuStrip)menuItemMRU.AccessibilityObject.;
            //}
            //catch
            //{
            //}
        ...
        {
            if (longName.Length > maxLen + 3)
            {
                return Path.GetPathRoot(longName) + "..." + longName.Substring(longName.Length - maxLen);
            }
            else
                return longName;
