...
using System.IO;
using System.Text;
using com.ibm.team.repository.client;
using com.ibm.team.repository.client.internalimpl;
using com.ibm.team.repository.common;
using com.ibm.team.scm.client;
using com.ibm.team.scm.common;
usign com.ibm.team.repository;
...
namespace RtcScm.Utility
{
    public class SourceControl : ISourceControl
    {
        ...
        public SourceControl(string serverNameUrl)
        {
            serverName = serverNameUrl;
            log.DebugFormat("Retrieved RTC SCM Server name: {0}", serverName);
        }
        ...
        public SourceControlStatus UpdateSourceControl(string fileName)
        {
            ...
            try
            {
                 ...
                 ITeamRepository rep = TeamRepositoryClient.DefaultInstance.GetTeamRepository(
                        serverName);

                RepositoryClientProxy repClient =
                    com.ibm.team.repository.client.internalimpl.RepositoryClientProxy.DefaultInstance;
                repClient.Login(rep);
               
       
                
                com.ibm.team.scm.Workspace[] spaces =  com.ibm.team.scm.client.ScmClient.DefaultInstance.GetWorkspaces(rep,null);
                ScmClient scmClient = com.ibm.team.scm.client.ScmClient.DefaultInstance;
                scmClient.
